...
Participants ($N_{participants}$=`r exp1$n_participants`) played the Totems game
for a single 25-minute session. Each participant was assigned to a single
generation within a single four-person team ($N_{teams}$=`r exp1$n_teams`).
Participants in generations 2-4 began the problem solving task with the
solutions that were discovered by the previous generation in their team. The
unique innovations of participants in generations 1-3 were inherited by one (and
only one) future generation.
...
In Experiment 1, we measured the problem solving ability of four-person diachronic
teams, and found that diachronic problem solvers were able to accumulate
...
the impact of inheritance on future problem solving. To this more interesting question,
the results of Experiment 1 on its own are not conclusive. Looking just at the
number of innovations discovered, it appeared that inheritance had a diminishing
return on problem solving, such that later generation participants, by way of
inheriting more solutions, had a harder time exceeding their ancestors than
earlier generations---suggesting a negative effect of inheritance on problem solving.
However, when the combinatorial difficulty of the problems being solved was taken into
account, a different conclusion was reached, namely that later generations of
diachronic problem solvers were able to solve more difficult problems than their
ancestors. A third conclusion was reached when looking just at the rate of
problem solving in the playing stage, where inheritance was not found to have an
effect on the rate at which new problems were solved.

We interpret these conflicting results as strong evidence that any conclusions
about the impact of diachronic inheritance on problem solving cannot be drawn
from studying diachronic collaboration in isolation. As a result, we use the
results of Experiment 1 to motivate the approach taken in Experiments 2-4 that
aims to understand the impact of diachronic inheritance on problem solving by
directly comparing the performance of diachronic teams to the performance
of alternative strategies for problem solving. Only by comparing the results of
diachronic collaboration to the result of alternative forms of collaboration can
the impact of inheritance on problem solving be adequately determined.
