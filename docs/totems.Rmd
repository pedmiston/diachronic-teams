...
the solutions obtained by their ancestors. Second, we determine how diachronic
problem solving is affected by the size of the inheritance. Finally, we
report how diachronic inheritance influences the type of solutions attempted by
...
generations, such that later generations of problem solvers benefitted less 
from inheritance than previous generations.
