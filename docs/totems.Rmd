...
```{r fig7, fig.width=6, fig.height=6}
efficiency_plot
```
...
```{r fig6, fig.width=8, fig.cap="**Team attempts predict number of inventions.** Teams that make more attempts tend to discover more inventions. Since synchronic teams make more attempts, they in turn discover more inventions."}
grid.arrange(
  attempts_plot,
