...
Our results are divided into three sections. First, we report the effect
of problem solving strategy on overall performance in terms of the total
number of innovations discovered by the end of the experiment. Second,
we report the effect of strategy on problem solving effectiveness, defined
as the number of guesses required to discover each new item. Third,
we report differences in guessing strategy caused by problem solving strategy.

Throughout the analyses our focus is on comparing the problem solving
ability of second generation diachronic participants to the other conditions
in the experiment.
