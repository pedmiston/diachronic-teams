...
abstract: |
  Human are able to pass on and inherit from others cultural products including
  tools and other technology like no other species of animal. What is the
  impact of inheritance---starting off a problem solving task with some of the
  problems already solved---on future problem solving ability? In
  Experiment 1, we demonstrate that future generations of problem solvers are
  able to cumulatively improve upon inherited solutions, but were unable to
  determine whether inheritance had an impact on problem solving ability. We
  resolve this issue in Experiments 2-4 by comparing diachronic problem solving
  to alternative strategies for solving the same set of problems but without
  diachronic inheritance. In Experiment 2 we demonstrate that diachronic
  inheritance results in fewer guesses per solution than problem solving
  without inheritance, but this benefit does not extend to solutions that were
  not inherited. In Experiment 3, we find that inheriting from oneself
  over repeated sessions is more effective than diachronic inheritance from
  someone else. However, we also find that diachronic inheritance can remediate
  the potential costs of fixation on incorrect solutions, which for isolated
  individuals can extend over multiple sessions. Experiment 4 includes
  four-person synchronic teams and finds that the inefficiencies of two-person
  synchronic teams are amplified for four-person teams such that diachronic
  colloration becomes more effective relative to synchronic collaboration as
  labor time increases. Together our results demonstrate cumulative gains
  though diachronic collaboration in a lab-based experiment, and identify some
  of the ways in which diachronic collaboration affords unique kinds of problem
  solving relative to alternative strategies for problem solving, namely that
  diachronic problem solving can remediate fixation effects and promote an
  overall less redundant guessing strategy.
csl: "theme/apa.csl"
