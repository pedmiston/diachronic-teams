...
incremental improvement, can sustain complex tools and other solutions to
problems that no individual could recreate on their own [@Boyd:2011gp].
Although the capacity to engage in cultural ratcheting is well-known, the
effectiveness of cultural transmission as a strategy for solving problems is an
area in need of further research. The purpose of this research was to better
understand the effectiveness of cultural transmission in accumulating solutions
to problems that no individual could recreate on their own.
...
strategies, but we also demonstrate the ways in which inheriting from
a previous generation results in a unique form of problem solving. In
...
generation, is comparable to alternative strategies for solving the same set of
problems in the same amount of labor time (see Fig. \@ref(fig:types-of-time)).
Two generations of diachronic problem solvers each working for 25 minutes
results in similar final performance to an isolated individual given 50 minutes
and two problem solvers working in parallel for 25 minutes each.
...
Given the tendency for individuals to get fixated in this task
[@Derex:2015cbb], we asked whether a diachronic or isolated strategy was more
effective at discovering new tools. To test this, we counted the number of
guesses it took each participant to make the first new tool after recreating
all inherited tools.
...
(ref:diachronic-v-isolated-inheritance) Costs and benefits of diachronic inheritance
relative to individual inheritance. **A.** Learning times by strategy.
...
discovering a new tool increased with new sessions.
...
We obtained evidence of one way in which a diachronic strategy can promote a
...
each strategy equally? Given that large groups are subject to effects such as
social loafing that decrease motivation and individual performance [@Mao:2016ds], we
hypothesized that diachronic collaboration would be more scalable than
synchronic collaboration. To test this, we compared diachronic and synchronic
collaboration given 50 minutes to the same strategies given 100 minutes.
...
In Experiment 3, we compared diachronic and synchronic collaboration strategies
at different team sizes, and found that diachronic and synchronic collaboration differ
in their ability to scale up to larger teams. Diachronic collaboration can add
more generations that each correspond to an increase in team performance, but
the added utility of adding problem solvers to a synchronic strategy is
smaller.
...
individually. We extended this line of research by comparing the effectiveness
of vertical transmission, where individuals start off a problem solving task by
inheriting directly from a previous generation.
...
Nonetheless, our results suggest that there may be different consequences
of horizontal and vertical transmission in a problem solving context. The
reason may be related to the unique learning environment experienced in
vertical transmission. In vertical transmission, new generations directly inherit and
...
knowledge after initial learning has already taken place. As a result,
vertical transmission may be able to promote problem solving behaviors that
