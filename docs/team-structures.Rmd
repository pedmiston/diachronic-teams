...
Generations 1-4 are labeled G1-G4. Isolated participants were recruited for
a single 50 minute session, or returned for four 25 minute sessions. Sessions
1-4 are labeled S1-S4. Synchronic participants were assigned to teams of two or
four individuals.
...
Note that participants who inherited an innovation record were provided the
recipes for creating the tools, not the tools themselves. In order use
these tools in further combinations, the tools and all of their constituent
parts first had to be recreated.
...
These results speak to the importance of controlling for labor hours when
trying to understand the impact of teamwork on problem solving.

We found an overall benefit to teamwork in this task. To test this, we compared
...
`r exp1$teamwork_stats`, with no residual difference between the diachronic and
...
We found that diachronic inheritance reduced the total number of guesses made
...
innovation for novel tools, not discovered by an ancestor.
