...
to invent tools on our own, but our ability to use and improve tools that were
invented by other people [@Boyd:2011gp]. Humans are exceptional social
learners, having evolved a number of abilities such as imitation, teaching, and
language that enable the sharing of tools and other solutions to problems with
other problem solvers. As a result, human cultures have been able to accumulate
complex tools that no individual could invent on their own.
