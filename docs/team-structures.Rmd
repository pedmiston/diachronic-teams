...
(ref:learning-times) **A.** Learning times by strategy. Learning time refers to
...
```{r cost-of-first-innovation, fig.height=6, fig.width=5, fig.cap="(ref:learning-times)"}
gridExtra::grid.arrange(learning_times_plot, first_discovery_plot, ncol = 1)
```
