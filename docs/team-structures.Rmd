...
(ref:team-structures-exp2) Problem solving strategies compared in Experiment 1.
...
```{r SelfOther, include=FALSE}
```

In Experiment 2, we compare the effectiveness of inheriting from someone else to
the effectiveness of inheriting from yourself (Fig. \@ref(fig:team-structures-exp3).
