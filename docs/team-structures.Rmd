...
Cumulative cultural evolution is enabled by the cultural transmission
of problem solving knowledge over generations.
\end{chapterAbstract}
...
individually [@Derex:2015cbb]. We extended this line of research by comparing
...
multiple modes of cultural transmission are observed occurring in the
wild, and not all of these were tested here [@Whiten:2008dl].

One limitation of these experiments is that both vertical and horizontal
