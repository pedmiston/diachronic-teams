...
complex tools that no individual could invent on their own in a process
known as cumulative cultural evolution.

Cumulative cultural evolution involves both vertical and horizontal forms of
transmission. Vertical transmission involves passing cultural products from
parent to child, whereas in horizontal transmission, cultural products are
passed among peers in the same generation. Although both forms of cultural
transmission involve social learning, the consequences of either vertical or
horizontal transmission have not been directly compared. Here we tested whether
problem solving knowledge that is inherited at the start of a problem solving
task via vertical transmission results in different problem solving performance
than purportedly the same knowledge shared horizontally among problem solvers
working in parallel.

In this research, we define vertical transmission as collaboration
...
defined as collaboration in parallel and in the same generation. We refer to
