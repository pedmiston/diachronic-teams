...
"ratchet effect" [@Tomasello:1993vh; @Dean:2013db], and is believed to be an
...
(ref:guess-rates) Guessing rate by session time.

```{r guess-rates, fig.width=6, fig.height=6, fig.cap="(ref:guess-rates)"}
grid.arrange(
  new_items_per_minute +
    labs(y = "", title = "A. New tools per minute") +
    theme(legend.position = "none"),
  guesses_per_minute +
    labs(y = "", title = "B. Guesses per minute") +
    theme(legend.position = "none"),
  unique_per_minute +
    labs(y = "", title = "C. Unique guesses per minute") +
    theme(legend.position = "none"),
  redundant_per_minute +
    labs(y = "", title = "D. Redundant guesses per minute") +
    theme(legend.position = "none"),
  nrow = 2
)
```
...
analyses explore why an isolated strategy was more effective than a diachronic
strategy. In investigating why an isolated strategy is more effective, we
uncover a benefit to diachronic collaboration in remediating the costs of
fixation suffered by isolated individuals.
...
compared to horizontal transmission and an isolated strategy. In comparing
...
Nonetheless, our results suggest that there may be different consequences of
horizontal and vertical transmission in a problem solving context. The reason
may be related to the unique learning environment experienced in vertical
...
is a unique form a problem solving worthy of further investigation.
