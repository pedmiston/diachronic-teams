...
cultural products among peers in the same generation. Some cultural products
are more likely to be passed vertically than horizontally. For example,
religious beliefs are more likely to be learned from parents than from peers
[@Newcomb:1937vy]. But far more cultural products are believed to be shared
among unrelated individuals via horizontal transmission. As a result,
...
another, indicating a process of horizontal transmission. Bettinger and
...
had the result of more similarity among projectile point designs.
This hypothesis has been supported by experimental and computational simulations
