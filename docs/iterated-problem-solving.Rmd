...
(ref:guesses-per-innovation) Guesses per tool by participant generation. Each line is the average number of guesses it took to discover a particular tool. Error bars show ±1 standard error of the model predictions. A. Inherited tools. B. Discovered tools, not inherited from an ancestor.
