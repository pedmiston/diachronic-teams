...
\@ref(fig:iterated-problem-solving-fig)). Previous research using this paradigm has
found that problem solving performance for simple tasks like folding paper
airplanes and building tours out of spaghetti can accumulate over generations
...
for successful transmission by allowing future generations to inherit the
discoveries made by the previous generation, and measured the ability of
participants to exceed the solutions they inherited.
