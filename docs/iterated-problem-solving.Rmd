...
`r exp1$guesses_per_item_by_inheritance`. This effect demonstrates the benefit of
...
(ref:guesses-per-innovation) Guesses per tool by generation. Each line is the average number of guesses it took to discover a particular tool. Error bars show ±1 standard error of the model predictions. A. Inherited tools. B. Discovered tools.

```{r guesses-per-innovation-1, fig.height=6, fig.cap="(ref:guesses-per-innovation)"}
grid.arrange(
