...
author-information: |
    ...
    \And {\large \bf Maxime Derex} \\ \texttt{maxime.derex@gmail.com} \\ Human Behaviour and Cultural Evolution Group \\ University of Exeter
...
keywords: "cultural evoltuion; transmission chain; iterated problem solving"
...
```{r innovations-by-generation, fig.env="figure", fig.cap="(ref:innovations-by-generation)"}
...
```{r learning-times, fig.width=6, fig.height=4, fig.env="figure*", fig.cap="Learning times. A. The distribution of learning times, with outliers highlighted. B. Linear relationship between inheritance sizes and learning times. Outliers excluded from the regression are shown as X's."}
grid.arrange(
