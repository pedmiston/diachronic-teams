...
improvement using an iterated problem solving paradigm (Fig. 1).
...
Cumulative cultural evolution is believed to require both the ability to copy
the innovations of others and the ability to adapt these innovations to improve
them in some way. These abilities are often distinguished as the products of
social learning and individual learning, respectively. Computational models of
the cultural evolutionary process have demonstrated many of the conditions
under which social learning is more advantageous than individual learning: when
the environment is stable and individual learning is costly [@Boyd:1983cu],
when social learners are able to filter among possible parents [@Enquist:2010gw].

; under these conditions, social learning provides
a valuable shortcut to individual learning [@Boyd:1983cu]. In this research
we seek to understand and quantify this shortcut so as to better understand


stipulate that the same


animals, since then a growing number of species have been identified as showing
evidence of the ability to inherit learned behaviors from the observation of
others. Cultural traditions sustained through social learning have been
identified in primates, monkeys, cetaceans, and birds. Experimental evidence of
social learning has been observed in a wider array of species, including rats,
fish, and even some insects. Given that social learning is at least possible in
diverse taxa, it is somewhat surprising that only a few cases have been
identified as showing any accumulation or improvement in inherited innovations.
New Caledonian crows have been argued to have improved the design plans for the
...
For the most part, tool use in animals has remained largely
unchanged for recorded history [@Mercader:2007fd], while over the same
period human technology has changed dramatically.



The accumulation of technological complexity in humans but no other animals 

As a result, many have
concluded that one of the primary factors driving human cultural evolution
is our ability to learn from 




(namely crows [@Hunt:2003dj], chimpanzees [@Sanz:2009ja], and perhaps
pigeons [@Sasaki:2017ha]) have demonstrated a capacity for cumulative
