...
The ability to inherit a tool or other solution to a problem stems from our
ability to socially learn from the observation and interaction with others, or
what @Thorndike:1898 called "from an act witnessed, learn to do an act" (p.
50). Thorndike's failed experiments on social learning in chicks, cats, and
dogs made him and many others skeptical that social learning was a widespread
phenomenon among animals. Since then, evidence has accumulated supplanting this view,
and identifying a growing number of species that appear able to inherit behaviors
from the observation of others. Some primates, monkeys,
cetaceans, and birds have been argued to demonstrate the ability to sustain
cultural traditions through social learning. Lab experiments have demonstrated
social learning abilities in some of these animals and others, including rats,
fish, and even some insects.

Given that social learning is present in diverse taxa, it is
surprising that only a few cases have been argued for any capacity for cumulative
cultural inheritance in non-human animals, namely crows [@Hunt:2003df], chimpanzees
[@Sanz:2009ja], and perhaps pigeons [@Sasaki:2017ha]. The signature
of cumulative cultural evolution is monotonic gains in some measure of
improvement.
