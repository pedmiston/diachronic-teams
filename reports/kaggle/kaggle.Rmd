...
```{r submissions-per-place, results = 'hide'}
```

```{r relative-submissions-per-place, results = 'hide'}
```

```{r place-from-submissions-mod, results = 'hide'}
```

```{r place-from-submissions, results = 'hide'}
```

```{r predicted-place-from-submission, results = 'hide'}
```
