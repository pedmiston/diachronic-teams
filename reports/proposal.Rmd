...
In understanding and explaining human cultural evolution, two causes that must be balanced are the relative roles of our cognitive abilities and the abilities afforded by the culture we are brought up in. Humans are smart, but we are also hoarders; human cultures accumulate artifacts, ideas, and information far more than any other culture [but see @]. Part of what makes this accumulation helpful is that people never have to start from scratch when solving a problem. People today inherit and adapt existing solutions to problems so pervasively as to make the story of technological invention one of near continuous change, with each new invention depending heavily on its precursors [@Ballas]. But what this historical evidence does not provide is a way to understand more directly the role of inheritance may play in the problem solving abilities of individuals. The experiments below are designed to test and measure the impact of inheritance on the problem solving abilities of individuals working together in teams. In the control condition, teams of four are given two hours in the same room to solve a problem. In the experimental condition, teams work one at a time, each inheriting as a starting point the previous team member's solution. Determining the types of problem solving most affected by team structure will be used as evidence to argue for the role of inheritance in understanding the problem solving abilities of humans. If inheritance plays a role in determining problem solving ability, then it suggests that the tools and abilities that allow and facilitate inheritance--e.g., having a way to inherit and modify past solutions--may be more important factors in the explaining the evolution of technology than accounting for the ingenuity of individuals.
