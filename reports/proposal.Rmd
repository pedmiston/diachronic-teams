...
```{r team-structure, engine = "dot", fig.cap = "Team structures. Teams of four are allotted the same number of total labor hours to solve a problem. Synchronic teams work all at the same time on a single solution. Diachronic teams work one at a time, each inheriting the previous solution and improving it."}
```
